...
export const friendsScreenStyles = StyleSheet.create({
  ...
  weekHeroStatusPillOnTrack: {
    borderColor: "rgba(34,197,94,0.45)",
    backgroundColor: "rgba(34,197,94,0.12)",
  },
  weekHeroStatusPillBehind: {
    borderColor: "rgba(251,191,36,0.45)",
    backgroundColor: "rgba(251,191,36,0.1)",
  },
  weekHeroStatusPillDone: {
  ...
  weekHeroBuddyCopy: { flex: 1, minWidth: 0 },
  weekHeroTextLink: {
    alignSelf: "flex-start",
    paddingVertical: spacing.xs,
  },
  weekHeroTextLinkText: {
    color: colors.primary,
    fontFamily: fontFamily.bodyMedium,
    ...typography.caption,
    textDecorationLine: "underline",
  },
  weekSetupWrap: { gap: spacing.sm },
  weekSetupStepLabel: {
    color: colors.textSecondary,
    fontFamily: fontFamily.bodyBold,
    ...typography.caption,
  ...
  weekSetupChipValueActive: { color: colors.textPrimary },
  weekSetupChipLabel: {
    color: colors.textSecondary,
    fontFamily: fontFamily.body,
    ...typography.caption,
  },
  weekSetupChipLabelActive: { color: colors.textPrimary },
  weekSetupActionRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: spacing.sm,
  ...
  weekSetupSecondaryBtn: {
    paddingHorizontal: spacing.md,
    minWidth: 88,
    alignItems: "center",
  },
  weekSetupPrimaryCol: { flex: 1 },
  heroSecondaryLink: {
    alignSelf: "center",
    paddingVertical: spacing.xs,
  },
  ...
  collapseHeaderTextCol: { flex: 1, minWidth: 0 },
  collapseHeaderTitle: {
    color: colors.textPrimary,
    fontFamily: fontFamily.heading,
    ...typography.body,
